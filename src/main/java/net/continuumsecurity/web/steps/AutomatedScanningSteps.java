...
public class AutomatedScanningSteps {
	...
	public void checkVulnerabilities() {
		assertThat(
				"No methods found annotated with @SecurityScan.  Nothing scanned.",
				app.getScannableMethods().size(), greaterThan(0));
